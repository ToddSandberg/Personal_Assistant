...
public class Chatbot {
	...
	static AudioPlaybackThread apt = new AudioPlaybackThread("");
			...
			responseObserver = new ResponseObserver<StreamingRecognizeResponse>() {
				...
				public void onComplete() {
					for (StreamingRecognizeResponse response : responses) {
						...
						com.google.cloud.speech.v1.SpeechRecognitionAlternative alternative = result
	...
	public static void checkInput(String result) {
		if (result.equals("hey " + Settings.bot_name) || result.equals("hello")) {
			...
			if (firstStartup) {
				String finalstring = "";
				finalstring += "Good " + greeting + " " + Settings.user_name + "! ";
				// TODO weather
				finalstring += getWeather() + " ";
				// TODO news debrief?
				// TODO get calendar
				playString(finalstring + "Anything else I can do for you?");
			} else {
			...
			if (news != null) {
				...
				playString(
						"Could not get your news. You may need to set your credentials or download the chrome driver.");
			}
	...
	public static String getWeather() {
		...
		try {
			URL url = new URL("http://api.openweathermap.org/data/2.5/weather?q=" + Settings.city + ","
					+ Settings.country_code + "&appid=f64957722661272de76a751839f0e552");
			...
			if (responsecode != 200)
				...
				temp = "" + faren;
				return "It looks like there's going to be " + weather + " today with a temperature of " + temp
						+ " degrees.";
			}
		} catch (Exception e) {
			e.printStackTrace();
...
class AudioPlaybackThread extends Thread {
	...
	AudioPlaybackThread(String sentence) {
